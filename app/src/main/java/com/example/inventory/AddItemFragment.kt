...
class AddItemFragment : Fragment() {
    ...
    private fun bind(item: Item) {
        ...
        binding.itemName.setText(item.itemName, TextView.BufferType.SPANNABLE)
        binding.itemPrice.setText(price, TextView.BufferType.SPANNABLE)
        binding.itemCount.setText(item.quantityInStock.toString(), TextView.BufferType.SPANNABLE)
